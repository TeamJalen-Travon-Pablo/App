...
import com.example.mypageapplication.Adapters.CommentAdapter;
import com.example.mypageapplication.Model.Comment;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile=findViewById(R.id.ic_profile_image);
    ...
    private void getImage()
    {
        reference.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.get().load(dataOne.getProfileUrl()).into(profile);
            }
