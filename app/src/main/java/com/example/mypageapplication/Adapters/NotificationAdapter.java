...
import com.example.mypageapplication.Model.Notifications;
import com.example.mypageapplication.Model.Posts;
import com.example.mypageapplication.OthersProfile;
import com.example.mypageapplication.PostDetails;
    ...
    private void getUserInfo(final ImageView imageView, final TextView username, String userid)
    {
        ...
        reference.child(userid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Data_One dataOne =snapshot.getValue(Data_One.class);

                username.setText(dataOne.getUsername());
                Picasso.get().load(dataOne.getProfileUrl()).into(imageView);
